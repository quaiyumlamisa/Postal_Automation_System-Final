...
<?php
  ...
  if(isset($_POST['sign_up']))
  {
...

      {
          ...
          INSERT INTO `staff`(`staff_id`, `staffName`, `StaffPhone`, `password`) VALUES ('$id','$name','$phone','$password')
            ...
            <form action="#" method="POST">
                <div class="row">
                    ...
                    <div class="input-group col-lg-8 mx-auto mb-4">
                        ...
                        <input id="staffName" type="text" name="staff_name" placeholder="Staff Name" class="form-control bg-white border-left-0 border-md">
                    </div>
                    ...
                    <div class="input-group col-lg-8 mx-auto mb-4">
                        ...
                        <input id="staffPhone" type="text" name="staff_phone" placeholder="Staff Phone Number" class="form-control bg-white border-left-0 border-md">
                    </div>
